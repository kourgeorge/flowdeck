...
from stock_deep_research.config import StockDeepResearchConfig
from stock_deep_research.prompts import (
...
from stock_deep_research.state import (
    AgentState,
    AgentInputState,
    ConductResearch,
    ResearchComplete,
...
from stock_deep_research.tools import get_all_tools
...
async def supervisor(state: SupervisorState, config: RunnableConfig) -> Command[Literal["supervisor_tools"]]:
    cfg = StockDeepResearchConfig.from_runnable_config(config)
    from stock_deep_research.tools import think_tool

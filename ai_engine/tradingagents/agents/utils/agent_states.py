...
class InvestDebateState(TypedDict):
    ...
    neutral_history: Annotated[
        str, "Neutral Conversation history"
...
class AgentState(TypedDict):
    ...
    market_score: Annotated[Optional[int], "Market analysis score from 1-5 indicating market performance outlook"]
    ...
    sentiment_score: Annotated[Optional[int], "Combined news & sentiment score from 1-5"]
    ...
    fundamentals_score: Annotated[Optional[int], "Fundamentals score from 1-5 indicating company financial health and fundamental strength"]
    ...
    sec_score: Annotated[Optional[int], "SEC/regulatory score from 1-5"]
    ...
    technical_score: Annotated[Optional[int], "Technical analysis score from 1-5 indicating stock performance"]
    ...
    valuation_score: Annotated[Optional[int], "Valuation score from 1-5 based on upside/downside to fair value"]
    ...
    recommendation_score: Annotated[Optional[int], "Recommendation score from 1-5 indicating confidence and strength of the investment recommendation"]
    ...
    risk_score: Annotated[Optional[int], "Risk score from 1-5 indicating confidence and strength of the risk assessment and final decision"]

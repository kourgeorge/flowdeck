...
try:
    ...
    get_ticker_data_via_service = None
...
def get_ticker_data(
    ...
    """
    if get_ticker_data_via_service is not None and info_service_configured():
        return get_ticker_data_via_service(symbol, start_date, end_date)
    return route_to_vendor("get_ticker_data", symbol, start_date, end_date)

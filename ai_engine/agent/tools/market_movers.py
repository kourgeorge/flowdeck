...
_SPEC = ToolSpec(
    ...
    description=(
        ...
        "or daily market movers. Optional 'count' (default 25) limits how many per list (1–100)."
    ),
    input_schema={
        "type": "object",
        "properties": {
            "count": {
                "type": "integer",
                "description": "Number of gainers and losers to return (each). Default 25, max 100.",
                "default": 25,
            },
        },
        "required": [],
...
class MarketMoversTool(BaseTool):
    ...
    def execute(self, ctx: ExecutionContext, *, count: int = 25, **_) -> ToolResult:
        try:

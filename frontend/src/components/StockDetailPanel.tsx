                        ...
                        <div className="flex-1">
                          ...
                          {modelsUsed && (modelsUsed.provider || modelsUsed.deep_think || modelsUsed.quick_think) && (
                            <div className="text-xs text-gray-400 mt-0.5">
                              Generated by {[modelsUsed.provider, modelsUsed.deep_think, modelsUsed.quick_think].filter(Boolean).join(', ')}
                              {stockData.report_days_ago != null && stockData.report_days_ago > 7 && <span className="text-amber-400/90 ml-1">Consider re-running for fresh insights.</span>}
                            </div>
                          )}
                        </div>

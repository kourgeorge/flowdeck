    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center px-4">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-lg font-semibold text-white mb-2">Sign in to use Vibe Trading</h2>
          <p className="text-gray-400 mb-6 text-sm">
            Vibe Trading combines the stock view with an AI analyst chat so you can research and discuss stocks side by side.
          </p>
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm">Loading Vibe Trading…</p>
        </div>
      </div>
    );
  }
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="shrink-0 border-b border-gray-700 bg-gray-800/80 px-4 py-2 flex items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-white">Vibe Trading</span>
        </div>
        {selectedTicker && (
...
/** Mobile-only tabbed view: Stock Detail | Chat */

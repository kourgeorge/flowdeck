    ...
    <div className="flex flex-col h-full bg-gray-900">
      ...
      <div className="shrink-0 border-b border-gray-700 bg-gray-800/80 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-semibold text-white">AI Stock Analyst</h1>
            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6">
              {!user ? (
                <div className="text-center max-w-sm">
                  ...
                  <h2 className="text-lg font-semibold text-white mb-2">Sign in to use AI Chat</h2>
                  <p className="text-sm text-slate-400 leading-relaxed">
                    Create a free account to chat with the AI Stock Analyst and get live market insights.
                  </p>
                </div>
              ) : (
                <>
